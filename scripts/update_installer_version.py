...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Comprezz Demo Installer\n"
      else:
        line="OutputBaseFilename=Comprezz Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Comprezz Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Comprezz installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Comprezz Demo installer\n"
     else:
       line="SetupWindowTitle=Comprezz installer\n"
